...
const TeamManager = () => {
    ...
    return (
        <div className='w-full min-h-screen pt-24 bg-slate-200 flex justify-center items-start'>
        <div className="max-w-md w-full mx-4 sm:mx-auto bg-white rounded-xl shadow-md overflow-hidden border-2 p-6">
          ...
          <div className="w-full sm:w-2/3 flex justify-between mt-4">
