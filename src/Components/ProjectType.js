...
const ProjectType = () => {
  ...
  return (
    ...
    <div className="w-full max-w-lg mx-4 sm:mx-auto bg-white shadow-md rounded-md p-4 sm:p-8 border-2 rounded-xl">
        <h2 className="text-xl font-semibold mb-2 text-center">Project type</h2>
        <p className="text-gray-600 mb-4 text-sm text-center">Don't panic — You can also customize this type in settings</p>
        ...
        <div className="mb-6">
            ...
            <div className="mb-4">
                ...
                <div className='flex flex-col sm:flex-row'>
                    <select
                        className="w-full sm:w-1/2 h-8 border border-gray-300 rounded-md mb-2 sm:mb-0"
                    ...
                    <input
                        ...
                        className="w-full sm:w-1/3 h-8 sm:ml-4 border border-gray-300 rounded-md"
                    />
                </div>
            </div>
